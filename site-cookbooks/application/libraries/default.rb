...
class Chef
  ...
  class Provider
    module ApplicationBase
      ...
      # TODO: pass the deploy option here
      def deploy_provider force = false
        @deploy_provider ||= begin
          deploy_provider = Chef::Platform.provider_for_resource(@deploy_resource, action( force ? :force_deploy : :deploy ))
